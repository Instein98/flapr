...
def sortPatchesByFL(susList: list, patchesDict: dict, CBeforeP=False):
    """
...
class Table:
    def __init__(self, pid, bid, columnNameList, flNameList, patchInfoDict):
        self.pid = pid
        self.bid = bid
    ...
    def calculateCells(self):
        for fl in self.flNameList:
            ...
            patchOrderedList = sortPatchesByFL(susList, self.patchInfoDict)
...
def generateSummary(pid: str, bid: str, prettyTable=False, isGzoltar=False):
    ...
    columnList = ['FL', '#PBeforeC', 'TimeToFind1stC', '1stBuggyStmtRank', '1stPorCStmtRank', 'AvgStmtTieNum', 'AvgPatchTieNum']
    table = Table(pid, bid, columnList, sbfls + lbfls, patchInfoDict)
...
if __name__ == '__main__':
    ...
    # generateSummary('Chart', '1', prettyTable=True, isGzoltar=True)